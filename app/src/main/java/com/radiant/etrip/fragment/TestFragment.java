...
import com.radiant.etrip.databinding.FragmentTestBinding;
...
public class TestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String latValueStart = bundle.getString("latitude_start");
        String lngValueStart = bundle.getString("longitude_start");
        String latValueEnd = bundle.getString("latitude_end");
        String lngValueEnd = bundle.getString("longitude_end");

        binding.latitudeStart.setText(latValueStart);
        binding.longitudeStart.setText(lngValueStart);
        binding.latitudeEnd.setText(latValueEnd);
        binding.longitudeEnd.setText(lngValueEnd);
